...
Tale UI targets the exact `react-aria-components` version `1.19.0`. The exact
...
| ------------------------------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `component-equivalence:button-group`              | ButtonGroup               | Adopt RAC 1.19.0 `Group` behind a Tale wrapper that owns naming, orientation, attached styling, and restricted render props.                                |
...
| `component-equivalence:resizable`                 | Resizable                 | Use direct exact `react-aria@3.50.0` `useMove` for pointer movement while Tale owns topology, keyboard behavior, projection, state, ARIA, and cancellation. |
